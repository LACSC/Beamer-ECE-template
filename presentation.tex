...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Frame %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Summary}
\frame[shrink]{% reduce wathever is in this slide to frame size. Purge if the summary is small
\tableofcontents
}
...
\section{About the Linux network stack}
\subsection{Components architecture}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Frame %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
% depending on your needs. This add a title on the top right of the slide
\frametitle{\ftitle{Components architecture}}
\end{frame}

\subsection{Bases of the Netfilter canvas}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Frame %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\frametitle{\ftitle{Bases of the Netfilter canvas}}
\end{frame}

\subsection{Links with the Network Interface Cards and drivers}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Frame %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\frametitle{\ftitle{Bases of the Netfilter canvas}}
\end{frame}

\section{The Netfilter canvas}
\subsection{General architecture}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Frame %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\frametitle{\ftitle{General architecture}}
\end{frame}

\subsection{Netfilter's behaviour}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Frame %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\frametitle{\ftitle{Netfilter's behaviour}}
\end{frame}

\subsection{Writing Netfilter's modules}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Frame %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\frametitle{\ftitle{Hooks and commands}}
\end{frame}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Frame %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\frametitle{\ftitle{Commands priorities support}}
\end{frame}
...
\subsection{What has been explained in this document}
...
\subsection{Index}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Frame %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\frame[allowframebreaks]{% allow multi-frames for the content. Can be used for summary also
